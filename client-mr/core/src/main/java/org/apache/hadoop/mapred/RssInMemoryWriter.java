...
public class RssInMemoryWriter<K, V> extends Writer<K, V> {
  private DataOutputStream out;
  private SortWriteBuffer<K, V> buffer;

  public RssInMemoryWriter(
      int partitionId,
    ...
    buffer =
        new SortWriteBuffer(
            partitionId, comparator, maxSegmentSize, keySerializer, valueSerializer);
  ...
  public SortWriteBuffer getBuffer() {
    return buffer;
  }
}
